package com.cosmicforge.rms.core.backup
...
data class BackupData(
    val date: String,
    val timestamp: Long,
    val orders: List<com.cosmicforge.rms.data.database.entities.OrderEntity>,
    val audits: List<com.cosmicforge.rms.data.database.entities.SecurityAuditEntity>
)
